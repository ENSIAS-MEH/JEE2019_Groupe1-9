	...
	///////////////////////////	
		...
		//a
			...
			System.out.println("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa1");
			 ...
			 //ici pour r�cup�rer la valeur d l id a partir du button cliqu� 
			 int i=0;
				char lettre;
				String lettre1="";
				while(true) {
		...
		if(action2!=null) {
			//had la partie pour r�cup�rer l id dial poll hit f submit kaybda b * ou be3dou description dial poll...
